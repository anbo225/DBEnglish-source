...
$lang = array(
	...
	'email_acitve_message' => '<img src="{imgdir}/mail_inactive.png" alt="未验证" class="vm" /> <span class="xi1">New mailbox({newemail})waiting for verification...</span><br />
								The system has sent a verified activation email to the mailbox, please check the email and verify the activation.<br>
								If you do not receive a confirmation message, you can change a mailbox, or<a href="home.php?mod=spacecp&ac=profile&op=password&resend=1" class="xi2"> resend validation email</a>',
